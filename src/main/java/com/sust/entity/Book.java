...
public class Book {
    ...
    public Book(Integer usId, String boName, String boCategory, Date boDate, String boEditor,
	...
	public Book(Integer boId, Integer usId, String boName, String boCategory,
			Date boDate, String boEditor, String boEditor2, Integer boFont,
			String boPublish, String boAbout, Date boUptime) {
		super();
		this.boId = boId;
		this.usId = usId;
		this.boName = boName;
