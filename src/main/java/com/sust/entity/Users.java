...
public class Users {
    ...
    public Users(String usName, String usAge, Byte usSex,
			Date usBirthday, String usNum, String usDuty, String usMajor,
			String usAddress, String usMail, String usPhone, String usAcademy,
			String usQuestion1, String usKey1, String usQuestion2, String usKey2) {
		this.usName = usName;
		this.usAge = usAge;
		this.usSex = usSex;
	...
	public Users(Integer usId, String usName, String usAge, Byte usSex,
			Date usBirthday, String usNum, String usDuty, String usMajor,
			String usAddress, String usMail, String usPhone, String usAcademy,
			String usQuestion1, String usKey1, String usQuestion2, String usKey2) {
		super();
