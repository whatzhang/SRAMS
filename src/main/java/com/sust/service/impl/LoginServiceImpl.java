...
public class LoginServiceImpl implements LoginService {
	...
	public String getLoginInfo(String account, String password, String type) {
		...
		logger.info("getLoginInfo:"+loginMapper.selectLoginByAccount(account)+"+++"+loginMapper.selectLoginByPass(password)+"+++"+loginMapper.selectLoginByAll(account,password,type));
	...
	public String saveNewInfo(String account, String pass, String type, String name,
		...
		String result = "fail";
		try {
			id = usersMapper.insertUserInfo(new Users(name,age,Byte.parseByte(sex),(new SimpleDateFormat("yyyy-MM-dd")).parse(brith),num,duty,major,address,mail,phone,academy,qu1,key1,qu2,key2));
