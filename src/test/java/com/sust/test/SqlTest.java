...
public class SqlTest {
	...
	public void loginSql(){
		...
		String result = "fail";
		try {
			id = usersMapper.insertUserInfo(new Users("aaass","11",Byte.parseByte("1"),(new SimpleDateFormat("yyyy-MM-dd")).parse("2100-2-3"),"12121211","sss","aaa","aaa","asas","asasasa","aaaa","aaaa","aaaa","aaaa","aaaa"));
		    if(id > -1){
	...
	public void dateTest(){
		...
		try {
			System.out.println(new SimpleDateFormat("yyyy/MM/dd-HH:mm:ss:SSS").parse(new SimpleDateFormat("yyyy/MM/dd-HH:mm:ss:SSS").format(new Date())));
