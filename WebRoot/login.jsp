...
<body>
	...
	<div id="page-wrapper"
		style="position: absolute; float: right; z-index: 1000; right: 13em; top: 14em;">
		<div class="main-page general">
			<div class=" panel-grids" style="width: 25em;">
				<div class="panel panel-danger">
					<div class="panel-heading" style="padding: 1.5em 0em 1.5em 0em;">
	...
	<script>
		...
		Tree = function() {
			...
			var geomTreeLeaves1 = new THREE.CylinderGeometry(1, 12 * 3, 12 * 3,
				4);
		...
		var AirPlane = function() {
			...
			suspensionGeom.applyMatrix(new THREE.Matrix4().makeTranslation(0,
				10, 0))
