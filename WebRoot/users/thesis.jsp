...
<body>
			...
			<div class="panel-info">
				<div class=" panel-body-inputin">
					<form class="form-horizontal"
						...
						id="findUserThesisInfo" name="findUserThesisInfo" method="get">
					...
					<c:if test="${isFind == 'yes'}">
						<div class="panel-heading success" style="vertical-align: middle;">
							查找信息 <a
								...
								href="${pageContext.request.contextPath}/thesis/downloadUserFind"
						...
						<table class="table table-bordered"
							...
							<thead>
								<tr>
									...
									<th
										style="text-align: center;vertical-align: middle; width: 7%;">论文类别</th>
									<th
										style="text-align: center;vertical-align: middle; width: 7%;">发表时间</th>
									<th
										style="text-align: center;vertical-align: middle; width: 7%;">论文级别</th>
									<th
										style="text-align: center;vertical-align: middle; width: 7%;">影响因子</th>
									<th
										style="text-align: center;vertical-align: middle; width: 7%;">是否收录</th>
									<th
									...
									<th
										style="text-align: center;vertical-align: middle; width: 7%;">起止页码</th>
									<th
										...
										<th align="center"
											...
											<div style="width: 100%;height: 2em;">
												...
												<li style="float: left; width: 0.7em;margin-left: 0.9em;"><a
													href="${pageContext.request.contextPath}/download/downloadTypeFile?type=thesis&id=${thList.thId}&isFind=yes"
						...
						<div style="float:right;">
							<a
								href="${pageContext.request.contextPath}/thesis/getUserPage?page=${page1.firstPage}&pageSize=${ps1}">第一页</a>
							<a
								href="${pageContext.request.contextPath}/thesis/getUserPage?page=${page1.nextPage}&pageSize=${ps1}">下一页</a>
							<a
								href="${pageContext.request.contextPath}/thesis/getUserPage?page=${page1.prePage}&pageSize=${ps1}">上一页</a>
							<a
								href="${pageContext.request.contextPath}/thesis/getUserPage?page=${page1.lastPage}&pageSize=${ps1}">最后页</a>
						</div>
						</p>
					</c:if>
					<c:if test="${isFind != 'yes'}">
						...
						<tbody>
							<c:forEach items="${requestScope.list}" var="tlist">
								<tr>
									<td
										style="text-align: center;vertical-align: middle; width: 4%;"><input
										type="checkbox" value="${tlist.thId}" name="thId"></td>
									<td
										style="text-align: center;vertical-align: middle; width: 7%;"
										data-toggle="tooltip" data-placement="top"
										title="${tlist.thName}">${tlist.thName}</td>
									<td
										style="text-align: center;vertical-align: middle; width: 7%;"
										data-toggle="tooltip" data-placement="top"
										title="${tlist.thCategory}">${tlist.thCategory}</td>
									<td
										style="text-align: center;vertical-align: middle; width: 7%;"
										data-toggle="tooltip" data-placement="top"
										title="${tlist.thDate}">${tlist.thDate}</td>
									<td
										style="text-align: center;vertical-align: middle; width: 7%;"
										data-toggle="tooltip" data-placement="top"
										title="${tlist.thLevel}">${tlist.thLevel}</td>
									<td
										style="text-align: center;vertical-align: middle; width: 7%;"
										data-toggle="tooltip" data-placement="top"
										title="${tlist.thFactor}">${tlist.thFactor}</td>
									<td
										style="text-align: center;vertical-align: middle; width: 7%;"
										data-toggle="tooltip" data-placement="top"
										title="${tlist.thIncluded}">${tlist.thIncluded}</td>
									<td
										style="text-align: center;vertical-align: middle; width: 7%;"
										data-toggle="tooltip" data-placement="top"
										title="${tlist.thNumber}">${tlist.thNumber}</td>
									<td
										style="text-align: center;vertical-align: middle; width: 7%;"
										data-toggle="tooltip" data-placement="top"
										title="${tlist.thJournal}">${tlist.thJournal}</td>
									<td
										style="text-align: center;vertical-align: middle; width: 7%;"
										data-toggle="tooltip" data-placement="top"
										title="${tlist.thPage}">${tlist.thPage}</td>
									<td
										style="text-align: center;vertical-align: middle; width: 25%;"
										data-toggle="tooltip" data-placement="top"
										title="${tlist.thAbout}">${tlist.thAbout}</td>
									<th align="center"
										style="width: 8%;text-align: center;vertical-align: middle;">
										<div style="width: 100%;height: 2em;">
											<li style="float: left; width: 0.7em;margin-left: 0.85em;"><a
												href="javascript:void(0);"
												onclick="showUpThInfo(${tlist.thId});" title="修改信息"> <i
													class="fa fa-cogs nav_icon" style="width: 0.15em"></i>
											</a></li>
											<li style="float: left; width: 0.7em;margin-left: 0.9em;"><a
												href="${pageContext.request.contextPath}/download/downloadTypeFile?type=thesis&id=${tlist.thId}"
												title="下载文件"> <i class="fa fa-download mail-icon"
													style="width: 1em;padding-left: 0.2em; "></i>
											</a></li>
											<li style="float: left; width: 0.7em;margin-left: 0.9em;"><a
												href="javascript:void(0);"
												onclick="delThInfo(${tlist.thId});" title="删除信息"> <i
													class="fa fa-trash-o mail-icon"
													style="width: 1em;padding-left: 0.2em; "></i>
											</a></li>
											<li
												style="float: left; width: 0.7em;margin-left: 0.8em;margin-right: 0.4em;"><a
												href="#myLookModal" onclick="setNum(${tlist.thId});"
												data-toggle="modal" data-target="#myLookModal" title="查看信息">
													<i class="fa fa-book nav_icon"
													style="width: 0.15em;padding-left: 0.1em; "></i>
											</a></li>
   ...
   function rePages1(){
       ...
       window.location.href = "${pageContext.request.contextPath}/thesis/getUserPage?pageSize="+page;
       window.parent.scrollTo(0, 0);
   }
   function findInfo() {
		if (confirm("确定要查找？")) {
