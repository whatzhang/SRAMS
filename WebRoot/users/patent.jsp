...
<body>
			...
			<div class="panel-info" style="margin-bottom: 1em;">
				<div class=" panel-body-inputin">
					<form class="form-horizontal"
						...
						id="findUserPatentInfo" name="findUserPatentInfo" method="get">
						<div class="form-group mb-n">
							<label for="largeinput" class=" control-label label-input-lg"
								style="margin-left: 2em; color: #e94e02;">选择查询条件及信息：</label> <a
								href="${pageContext.request.contextPath}/download/downloadTypeExcl?type=patent"><button
					...
					<c:if test="${isFind == 'yes'}">
						<div class="panel-heading success" style="vertical-align: middle;">
							查找信息 <a
								...
								href="${pageContext.request.contextPath}/patent/downloadUserFind"
										...
										<th align="center"
											...
											<div style="width: 100%; height: 2em;">
												...
												<li style="float: left; width: 0.7em; margin-left: 0.9em;"><a
													href="${pageContext.request.contextPath}/download/downloadTypeFile?type=patent&id=${palist.paId}&isFind=yes"
						...
						<div style="float:right;">
							<a
								href="${pageContext.request.contextPath}/patent/getUserPage?page=${page1.firstPage}&pageSize=${ps1}">第一页</a>
							<a
								href="${pageContext.request.contextPath}/patent/getUserPage?page=${page1.nextPage}&pageSize=${ps1}">下一页</a>
							<a
								href="${pageContext.request.contextPath}/patent/getUserPage?page=${page1.prePage}&pageSize=${ps1}">上一页</a>
							<a
								href="${pageContext.request.contextPath}/patent/getUserPage?page=${page1.lastPage}&pageSize=${ps1}">最后页</a>
						</div>
						</p>
					</c:if>
					<c:if test="${isFind != 'yes'}">
   ...
   function rePages(){
    ...
    function rePages1(){
       ...
       window.location.href = "${pageContext.request.contextPath}/patent/getUserPage?pageSize="+page;
       window.parent.scrollTo(0, 0);
   }
   function findInfo() {
		if (confirm("确定要查找？")) {
