...
<body>
	...
	<div class="main-page">
						...
						<ul>
							...
							<li><a href="javascript:void(0);"><i
									class="fa fa-file-text-o"></i>已读消息用户数<span><label
										id="ReNum">2</label></span></a></li>
							<li><a href="javascript:void(0);"><i
									class=" fa fa fa-envelope-o"></i>删除消息用户数<span><label
										id="DelNum">3</label></span></a></li>
						</ul>
					</div>
				...
				<div class="panel-body">
					<form class="com-mail">
						...
						<input type="text" class="form-control1 control3"
							placeholder="To :" required="required"> <input
							type="text" class="form-control1 control3" placeholder="消息主题">
		...
		<div>
			<div class="panel-info" style="margin: 0em 1em 0em 1em;">
					...
					<table class="table table-bordered">
						<thead>
							<tr>
								...
								<th
									style="text-align: center;vertical-align: middle;width: 16%;">消息主题</th>
								<th
									style="text-align: center;vertical-align: middle;width: 12%;">发布时间</th>
								<th
									style="text-align: center;vertical-align: middle;width: 12%;">发布人</th>
								<th
									style="text-align: center;vertical-align: middle;width: 12%;">接收人</th>
								<th
									style="text-align: center;vertical-align: middle;width: 31%;">消息内容</th>
								<th
									style="text-align: center;vertical-align: middle;width: 12%;">操作选项</th>
							</tr>
						</thead>
						<tbody>
							<c:forEach items="${requestScope.MeList}" var="Me">
								<tr>
									...
									<td
										...
										data-toggle="tooltip" data-placement="top"
										title="${Me.meDate}">${Me.meDate}</td>
									<td
										style="text-align: center; vertical-align: middle;width: 12%;"
										data-toggle="tooltip" data-placement="top"
										title="${Me.meSend}">${Me.meSend}号用户</td>
									<td
										style="text-align: center; vertical-align: middle;width: 12%;"
										data-toggle="tooltip" data-placement="top"
									...
									<th align="center"
										...
										<div style="width: 100%; height: 2em;">
											<li style="float: left; width: 0.7em; margin-left: 0.5em;"><a
												href="#myModal" onclick="chMessage(${Me.meId});"
												data-toggle="modal" data-target="#myModal" title="修改信息">
						...
						<div class="modal-body" style="margin: 0.2em 1em 0em 1em;">
							...
							<div class="form-group mb-n">
								<label for="largeinput">发布人&nbsp;&nbsp;&nbsp;</label> <input
									...
									id="send" required="required" readonly="readonly"> </label>
							</div>
							<div class="form-group mb-n">
								<label for="largeinput">接收人&nbsp;&nbsp;&nbsp;</label> <input
									type="text" style="width: 37em;"
									class="form-control1 input-lg " id="resevice"
									required="required" readonly="readonly"> </label>
							</div>
							<div class="form-group mb-n">
	...
	<script type="text/javascript">
		...
		function setMyModel(data) {
			if(isCh == "ch"){
			    $("#meChange input").a;ttr("readonly",false);
			    alert(isCh);
			}
