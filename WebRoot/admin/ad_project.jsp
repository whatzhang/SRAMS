...
<body>
	...
	<div class="main-page">
		<div class="media">
			<div class="panel-info widget-shadow" id="pro_find">
			...
			<div class="bs-example5 widget-shadow"
				data-example-id="default-media" id="pro_show">
				<table class="table table-bordered">
					<thead>
						<tr class="success">
							<th scope="row" style="text-align: center;">项目名称</th>
							<th style="text-align: center;">项目类别</th>
							<th style="text-align: center;">立项时间</th>
							<th style="text-align: center;">项目进度</th>
							<th style="text-align: center;">项目leader</th>
							<th style="text-align: center; width: 8em;">项目成员</th>
							<th style="text-align: center; width: 12em;">项目简介</th>
					...
					<tbody>
						<tr>
							...
							<td style="text-align: center;">1111</td>
							<td style="text-align: center;">1111</td>
							<td style="text-align: center; width: 8em;">1111</td>
							<td style="text-align: center; width: 12em;">1111</td>
							<td>
								<div class="dropdown">
			...
			<div class="media_1">
				<div class="col-md-6 media_1-left widget-shadow" id="pro_add">
					<div class="panel_2" style="padding: 2em 2em 2em 2em;">
						...
						<form class="form-horizontal" id="add" name="add">
							<br>
							<div class="form-group mb-n">
								<label for="largeinput">项目名称</label> <input type="text"
							...
							<div class="form-group mb-n">
								<label for="largeinput">项目类别</label> <input type="text"
									class="form-control1 input-lg"
									style="width: 17em; margin-left: 1em" id="largeinput"
									placeholder=" ">
							</div>
							<div class="form-group mb-n">
								<label for="largeinput">立项时间</label> <input type="text"
									style="width: 17em; margin-left: 1em" name="Cdate"
									readonly="readonly" class="form-control1 input-lg" id="Cdate" />

							</div>
							<div class="form-group mb-n">
								<label for="largeinput" style="float: left;">项目进度</label>
								<div class="col-sm-4">
									<select  class="form-control1">
										<option>&lt;25%</option>
										<option>&gt;20%&nbsp;&lt;50%</option>
							...
							<div class="form-group mb-n">
								<label for="largeinput">项目leader</label> <input type="text"
									class="form-control1 input-lg"
									style="width: 17em; margin-left: 1em" id="largeinput"
									placeholder=" ">
							...
							<div class="form-group mb-n">
								<label for="largeinput">项目成员</label>

								<textarea rows="2" class="form-control1 control2"
									style="height: 5em;" placeholder=""></textarea>

							</div>
							<div class="form-group mb-n">
								<label for="largeinput">项目简介</label>
				...
				<div class="col-md-5 media_1-right widget-shadow" id="pro_up">
