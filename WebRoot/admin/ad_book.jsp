...
<body>
	<div class="main-page">
			...
			<div class="panel-info">
				<div class=" panel-body-inputin">
					<form class="form-horizontal"
						action="${pageContext.request.contextPath}/book/findBookInfo"
						...
						<div class="form-group mb-n">
							<label for="largeinput" class=" control-label label-input-lg"
								...
								href="${pageContext.request.contextPath}/download/downloadAllTypeExcl?type=book"><button
					...
					<c:if test="${isFind == 'yes'}">
						<div class="panel-heading success" style="vertical-align: middle;">
							查找信息 <a
								...
								href="${pageContext.request.contextPath}/book/downloadFind"
										...
										<th align="center"
											...
											<div style="width: 100%; height: 2em;">
												...
												<li style="float: left; width: 0.7em; margin-left: 0.9em;"><a
													href="${pageContext.request.contextPath}/download/downloadTypeFile?type=book&id=${boList.boId}&isFind=yes&role=AD""
													title="下载文件"> <i class="fa fa-download mail-icon"
														style="width: 1em; padding-left: 0.2em;"></i>
												</a></li>
												<li style="float: left; width: 0.7em; margin-left: 0.9em;"><a
													href="javascript:void(0);"
													onclick="delInfo(${boList.boId});" title="删除信息"> <i
						...
						<div style="float:right;">
							<a
								href="${pageContext.request.contextPath}/book/getPage?page=${page1.firstPage}&pageSize=${ps1}">第一页</a>
							<a
								href="${pageContext.request.contextPath}/book/getPage?page=${page1.nextPage}&pageSize=${ps1}">下一页</a>
							<a
								href="${pageContext.request.contextPath}/book/getPage?page=${page1.prePage}&pageSize=${ps1}">上一页</a>
							<a
								href="${pageContext.request.contextPath}/book/getPage?page=${page1.lastPage}&pageSize=${ps1}">最后页</a>
						</div>
						</p>
					</c:if>
					<c:if test="${isFind != 'yes'}">
							...
							<c:forEach items="${requestScope.BookList}" var="RaceList">
								<tr>
									...
									<td
										style="text-align: center; vertical-align: middle; width: 9%;"
										data-toggle="tooltip" data-placement="top"
										title="${RaceList.boUptime}">${RaceList.boUptime}</td>
									<th align="center"
										style="width: 8%; text-align: center; vertical-align: middle;">
										<div style="width: 100%; height: 2em;">
											<li style="float: left; width: 0.7em; margin-left: 0.85em;"><a
											...
											<li style="float: left; width: 0.7em; margin-left: 0.9em;"><a
												href="${pageContext.request.contextPath}/download/downloadTypeFile?type=book&id=${RaceList.boId}&role=AD"
												title="下载文件"> <i class="fa fa-download mail-icon"
													style="width: 1em; padding-left: 0.2em;"></i>
											</a></li>
											<li style="float: left; width: 0.7em; margin-left: 0.9em;"><a
		...
		<div class="media">
			<div class="panel-info" id="pa_add" style="padding: 0em 2em 1em 2em;"
				id="UpAndDe">
...
<script type="text/javascript">
	...
	function rePages1(){
       ...
       window.location.href = "${pageContext.request.contextPath}/book/getPage?pageSize="+page;
       window.parent.scrollTo(0, 0);
   }
   function findInfo() {
		if (confirm("确定要查找？")) {
