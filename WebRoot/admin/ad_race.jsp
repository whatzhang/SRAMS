...
<body>
	...
	<div class="main-page">
		<div class="media">
			<div class="panel-info widget-shadow" id="ra_find">
			...
			<div class="bs-example5 widget-shadow"
				data-example-id="default-media" id="ra_show">
				<table class="table table-bordered">
					<thead>
						<tr class="success">
							<th scope="row" style="text-align: center;">竞赛名称</th>
							<th style="text-align: center;">竞赛类别</th>
							<th style="text-align: center;">个人/团体</th>
							<th style="text-align: center;">竞赛时间</th>
							<th style="text-align: center; width: 14em;">竞赛简介</th>
			...
			<div class="media_1">
				<div class="col-md-6 media_1-left widget-shadow">
					<div class="panel_2" style="padding:2em 2em 0em 2em;">
						<form class="form-horizontal" id="add" name="add">
							...
							<div class="form-group mb-n">
								<label for="largeinput">竞赛类别<label> <input
										type="text" class="form-control1 input-lg"
										style="width: 17em; margin-left: 1em" id="largeinput"
										placeholder=" ">
							</div>
							<div class="form-group mb-n">
								<label for="largeinput">竞赛时间</label><input type="text"
									style="width: 17em; margin-left: 1em" name="Cdate"
									readonly="readonly" class="form-control1 input-lg" id="Cdate" />

							</div>
							<div class="form-group mb-n">
								<label for="largeinput">个人/团体</label> <input type="text"
									class="form-control1 input-lg" style="width: 17em;left: 0em"
									id="largeinput" placeholder=" ">
							</div>
							<div class="form-group mb-n">
								<label for="largeinput">竞赛简介</label>
				...
				<div class="col-md-6 media_1-right widget-shadow">
					<div class="panel_2 panel_3" style="padding:2em 2em 0em 2em;">
