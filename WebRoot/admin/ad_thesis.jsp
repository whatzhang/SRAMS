...
<body>
	...
	<div class="main-page">
			...
			<div class="panel-info widget-shadow" id="th_find">
				<div class=" panel-body-inputin" style="height: 7em;">
					<form class="form-horizontal" name="find_th">
			...
			<div class="panel-info widget-shadow" id="th_show">
			...
			<div class="media_1">
				<div class="col-md-6 media_1-left widget-shadow" id="th_add">
					<div class="panel_2" style="padding: 2em 2em 2em 2em;">
						<form class="form-horizontal" id="add" name="add">
							...
							<br>
							<div class="form-group mb-n">
								<label for="largeinput">论文名称</label> <input type="text"
							...
							<div class="form-group mb-n">
								<label for="largeinput">论文类别</label> <input type="text"
									class="form-control1 input-lg"
									style="width: 17em; margin-left: 1em" id="largeinput"
									placeholder=" ">
							</div>
							<div class="form-group mb-n">
								<label for="largeinput">发表时间</label> <input type="text"
									style="width: 17em; margin-left: 1em" name="Cdate"
									readonly="readonly" class="form-control1 input-lg" id="Cdate" />

							</div>
							<div class="form-group mb-n">
								<label for="largeinput">论文作者</label><input type="text"
									class="form-control1 input-lg"
									style="width: 17em; margin-left: 1em" id="largeinput"
									placeholder=" ">
							</div>
							...
							<div class="form-group mb-n">
								<label for="largeinput">发表期刊</label> <input type="text"
									class="form-control1 input-lg"
									style="width: 17em; margin-left: 1em" id="largeinput"
									placeholder=" ">
							</div>
							...
							<div class="form-group mb-n">
								<label for="largeinput">论文简介</label>
				...
				<div class="col-md-6 media_1-right widget-shadow" id="th_up">
